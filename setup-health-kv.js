...
/**
 * Script to create and set up the HEALTH_KV namespace in Cloudflare
 * 
 * Usage:
 * 1. Install wrangler globally: npm install -g wrangler
 * 2. Login to Cloudflare: wrangler login
 * 3. Run this script: node setup-health-kv.js
 * 
 * This script will:
 * 1. Create the HEALTH_KV namespace if it doesn't exist
 * 2. Output the KV namespace ID and preview ID
 * 3. Provide instructions for adding these as GitHub Action secrets
 */
...
// Create the HEALTH_KV namespace
...
console.log('   - Name: HEALTH_KV_ID');
console.log(`   - Value: ${namespaceId}`);
console.log('   - Name: HEALTH_KV_PREVIEW_ID');
...
console.log('\nYou can also add these values to your local wrangler.toml files for testing:');
console.log('```toml');
console.log('[[kv_namespaces]]');
console.log('binding = "HEALTH_KV"');
